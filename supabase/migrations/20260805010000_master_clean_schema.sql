-- ==============================================================================
-- MASTER CLEAN MIGRATION SQL: ANXIS Production Database Schema
-- Safely cleans old unused tables and creates ONLY the current active schema
-- ==============================================================================
...
-- 2. DROP UNUSED / LEGACY TABLES SAFELY (CLEAN REORGANIZATION)
DROP TABLE IF EXISTS public.leads CASCADE;
DROP TABLE IF EXISTS public.portfolio_items CASCADE;
DROP TABLE IF EXISTS public.user_roles CASCADE;

-- 3. ACTIVE SYSTEM ROLES TABLE
...
-- 4. ACTIVE SYSTEM PERMISSIONS TABLE
...
-- 7. USER PERMISSIONS OVERRIDES TABLE
...
-- 21. ROW LEVEL SECURITY (RLS) ENABLEMENT ON ALL ACTIVE TABLES
